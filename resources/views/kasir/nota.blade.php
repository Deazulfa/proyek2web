    ...
    <div id="invoice-POS">
        ...
        <div id="mid">
            <div class="info">
                ...
                <p>
                    Kode Pesanan : {{ $kasir->kode_pesanan }}</br>
                    Tanggal Pesanan : {{ $kasir->created_at }}</br>
                </p>
            </div>
        </div><!--End Invoice Mid-->
            ...
            <div id="table">
                <table>
                    ...
                    @foreach ($detailPesanan as $item)
                        <tr class="service">
                            <td class="tableitem">
                                <p class="itemtext">{{ $item->product->nama_produk }}</p>
                            </td>
                            <td class="tableitem">
                                <p class="itemtext">{{ $item->jumlah }}</p>
                            </td>
                            <td class="tableitem">
